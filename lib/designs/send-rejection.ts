export const sendRejectedEmail = `<!DOCTYPE html>
														...
														<tr>
															<td class="pad" style="padding-bottom:5px;padding-left:5px;padding-right:5px;">
																<div style="color:#454562;font-family:'Roboto',Tahoma,Verdana,Segoe,sans-serif;font-size:38px;line-height:1.2;text-align:center;mso-line-height-alt:46px;">
																	<p style="margin: 0;"><strong>Update on Your Application</strong></p>
																</div>
															</td>
														</tr>
													</table>
													...
													<table class="paragraph_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
																<div style="color:#555555;font-family:Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif;font-size:14px;line-height:1.5;text-align:left;mso-line-height-alt:21px;">
																	<p style="margin: 0;">Dear {{name}},</p>
																	<p style="margin: 0;">&nbsp;</p>
																	<p style="margin: 0;">Thank you for your interest and the time you invested in the application process.</p>
																	<p style="margin: 0;">&nbsp;</p>
																	<p style="margin: 0;">After careful consideration, we regret to inform you that you have not been selected for this particular role. However, we encourage you to explore other opportunities that may align more closely with your profile — whether with different teams or companies.</p>
																	<p style="margin: 0;">&nbsp;</p>
																	<p style="margin: 0;">Your continued engagement with our platform can help you stay updated on relevant roles and increase your chances of finding the right fit.</p>
																	<p style="margin: 0;">&nbsp;</p>
																	<p style="margin: 0;">We appreciate your effort and wish you the very best in your job search.</p>
																	<p style="margin: 0;">&nbsp;</p>
																	<p style="margin: 0;">Warm regards,<br>Reeturaj Kumar<br>HIRETRACK - A Platform For Hiring</p>
																</div>
															</td>
														</tr>
													</table>
